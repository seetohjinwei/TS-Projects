...
class Game {
    ...
    toggleFlag(): void {
        const displayFlagMode: HTMLSpanElement = <HTMLSpanElement>(
            document.getElementById("display-flag-mode")
        );
        this.flag = !this.flag;
    ...
    toggleCheat(): void {
        const displayCheatMode: HTMLSpanElement = <HTMLSpanElement>(
            document.getElementById("display-cheat-mode")
        );
...
class Board {
    ...
    update(): void {
        const playArea: HTMLTableElement = <HTMLTableElement>(
            document.getElementById("display-board")
        );
...
class Bombs {
    ...
    displayCurr(): void {
        ...
        const displayCurrBombs: HTMLSpanElement = <HTMLSpanElement>(
            document.getElementById("display-curr-bombs")
        );
    ...
    displayTotal(): void {
        ...
        const displayTotalBombs: HTMLSpanElement = <HTMLSpanElement>(
            document.getElementById("display-total-bombs")
        );
