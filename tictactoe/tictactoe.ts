...
function buttons(): void {
    const buttonAIEasy: HTMLButtonElement = <HTMLButtonElement>(
        document.getElementById("button-ai-easy")
    );
    const buttonAIHard: HTMLButtonElement = <HTMLButtonElement>(
        document.getElementById("button-ai-hard")
    );
    const buttonAINo: HTMLButtonElement = <HTMLButtonElement>(
        document.getElementById("button-no-ai")
    );
    const buttonRestart: HTMLButtonElement = <HTMLButtonElement>(
